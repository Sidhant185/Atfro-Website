...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] max-w-[1340px] flex-col items-center gap-8 px-6 pt-10 md:flex-row md:gap-0 md:pt-0">

        {/* ── Left: Copy ───────────────────────────────────────────────────── */}
        <div className="flex-[0_0_48%] text-center md:text-left md:pr-8">
          <motion.p
            className="mb-5 text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--color-hero-accent)]"
          ...
          <motion.h1
            className="text-[clamp(2.6rem,5vw,4.5rem)] font-extrabold leading-[1.04] tracking-[-0.03em] text-[var(--color-hero-text)]"
          ...
          <motion.p
            className="mt-8 text-xs text-[var(--color-hero-muted)] opacity-60"
        ...
        >
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              {/* The phone image — large & proud */}
              <div
                className="relative"
                style={{
                  width: "clamp(280px, 38vw, 520px)",
                  filter: "drop-shadow(0 40px 80px rgba(0,0,0,0.16)) drop-shadow(0 12px 28px rgba(0,0,0,0.1))",
                }}
              >
                <Image
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(100deg, transparent, rgba(255,255,255,0.55) 45%, rgba(255,255,255,0.75) 50%, rgba(255,255,255,0.55) 55%, transparent)",
                    }}
                  />
                </motion.div>
              </div>
